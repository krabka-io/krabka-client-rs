...
/// Publish the member epoch of the consumer group protocol as the generation
/// that commits carry. Kafka sends the member epoch of a consumer-protocol
/// member in `OffsetCommit.generationIdOrMemberEpoch`.
